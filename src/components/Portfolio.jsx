    ...
    const portfolios = [
        {
            ...
            content: <span>SyncSpace is a Reddit-like website built using the <b>MERN</b> stack (MongoDB, Express.js, React.js, Node.js).</span>
        },
        {
            ...
            content: <span>A web app to connect potential donors to nearby NGOs for tackling wastage of resources; using <b>Node.js</b>, <b>Express.js</b> and <b>MongoDB</b>.</span>
        },
        {
            ...
            content: <span>A simple <b>To-Do List</b> project to try and implement Node.js, Express.js alongside MongoDB to my previous project:<a href="https://karan-bisht16.github.io/js-To_Do_List/" target="_blank" rel="noreferrer" className="flex items-center gap-1 font-bold ml-4">js-To_Do_List <FaExternalLinkAlt size={10} />.</a></span>
        },
        {
            ...
            content: <span>A basic <b>To-Do List</b> made strictly using <b>React.js</b> and doesn't employ Node.js, Express.js or MongoDB connectivity.</span>
        },
        {
        ...
        },
        {
            ...
            content: <span>A simple website made only using HTML, CSS and <b>Bootstrap</b>. This project implements Piet Mondrian's neoplastic artworks using the CSS grid layout.</span>
        },
    ];
